...
FIXTURE_BOTS = [
    {
        ...
        'master_qq': '10001',
        'version': 'v1.0.0',
        'description': 'keyword-alpha online sample',
        'is_public': True,
        'status': 'online',
    },
    {
        ...
        'master_qq': '10001',
        'version': 'v1.0.1',
        'description': 'keyword-beta offline sample',
        'is_public': True,
        'status': 'offline',
    },
    {
        ...
        'master_qq': '10002',
        'version': 'v1.1.0',
        'description': 'keyword-gamma online sample',
        'is_public': True,
        'status': 'online',
    },
    {
        ...
        'master_qq': '10003',
        'version': 'v1.2.0',
        'description': 'private fixture for ownership checks',
        'is_public': False,
        'status': 'offline',
    },
    {
        ...
        'master_qq': '10001',
        'version': 'v1.3.0',
        'description': 'keyword-empty boundary sample',
        'is_public': True,
        'status': 'unknown',
    },
]
